...
from .models import user_registrated, AdvUser, SuperRubric, SubRubric, Bb, AditionalImage, Comment
...
class RegisterUserForm(forms.ModelForm):
	...
	password2 = forms.CharField(label='Пароль (повторно)',
								widget=forms.PasswordInput,
								help_text='Введите тот де ссамый пароль еще раз для проверки')
	...
	def clean(self):
		...
		if password1 and password2 and password1!=password2:
			errors  = {'password2': ValidationError('Введенные пароль не совпадают', 
